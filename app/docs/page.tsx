    ...
    content: (
      <div className="space-y-6 text-sm leading-relaxed">
        ...
        <div className="space-y-4">
          ...
          <p>1.1. Настоящая публичная оферта является официальным предложением сервиса Fluxor заключить договор на оказание услуг хостинга.</p>
  ...
  terms: {
    ...
    content: (
      <div className="space-y-6 text-sm leading-relaxed">
        ...
        <div className="space-y-4">
          <h3 className="font-bold">1. ОБЩИЕ ПОЛОЖЕНИЯ</h3>
          <p>1.1. Настоящее Соглашение регулирует отношения между сервисом Fluxor и пользователем услуг.</p>
          ...
          <div className="mt-16 pt-8 border-t border-gray-300">
            <div className="grid grid-cols-2 gap-8">
              <div className="space-y-2">
                <p className="font-bold text-xs">Директор Fluxor</p>
