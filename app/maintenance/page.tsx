...
const links = [
  { name: "Панель управления", url: "https://console.fluxor.solutions", icon: LayoutDashboard },
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="max-w-md w-full text-center relative z-10">
        ...
        <div className="flex items-center justify-center gap-2 mb-4">
          <Image src="/logo.svg" alt="Fluxor" width={8} height={8} className="size-8" />
          <span className="font-heading text-2xl font-bold text-foreground">Fluxor</span>
        </div>
