...
const faqItems = [
  ...
  },
  {
    ...
    answer: "Да, вы можете изменить тариф в любой момент через панель управления. При повышении тарифа разница будет рассчитана пропорционально оставшемуся времени. При понижении тарифа вы получите возврат средств за неиспользованное время."
  },
  {
    icon: Headphones,
